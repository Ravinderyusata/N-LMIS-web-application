...
public class AdmUserV implements
 Serializable{
	@Id @GeneratedValue(generator="increment")
	@GenericGenerator(name="increment", strategy = "increment")
	@Column(name="USER_ID") private Integer x_USER_ID;
	@Column(name="TELEPHONE_NUMBER") private String x_TELEPHONE_NUMBER;
	@Column(name="STATUS") private String x_STATUS;
	@Column(name="START_DATE") private Date x_START_DATE;
	@Column(name="ROLE_NAME") private String x_ROLE_NAME;
	@Column(name="ROLE_ID") private Integer x_ROLE_ID;
	@Column(name="ROLE_DETAILS") private String x_ROLE_DETAILS;
	@Column(name="PASSWORD") private String x_PASSWORD;
	@Column(name="MIDDLE_NAME") private String x_MIDDLE_NAME;
	@Column(name="LOGIN_NAME") private String x_LOGIN_NAME;
	@Column(name="LAST_NAME") private String x_LAST_NAME;
	@Column(name="FIRST_NAME") private String x_FIRST_NAME;
	@Column(name="END_DATE") private Date x_END_DATE;
	@Column(name="EMAIL") private String x_EMAIL;
	@Column(name="COMPANY_ID") private Integer x_COMPANY_ID;
	@Column(name="ACTIVATED_ON") private Date x_ACTIVATED_ON;
	@Column(name="ACTIVATED_BY") private Integer x_ACTIVATED_BY;
	@Column(name="WAREHOUSE_NAME") private String x_WAREHOUSE_NAME;
	@Column(name="WAREHOUSE_ID") private Integer x_WAREHOUSE_ID;
	@Column(name="USER_TYPE_NAME") private String x_USER_TYPE_NAME;
