...
<div class="row" style="margin-bottom: 0px;">
	<div class="col l1" style="height:118px; width:142px">
		<img class="responsive-img" style="height: 117px; width:142px" alt="NPHCDA_LOGO" 
    ...
    <div class="col l2 valign-wrapper" style="height: 118px; width:194px; line-height:25px">      	
		<div class="row valign valign-wrapper logout_div">			
			<a id="logout_btn" href="loginPage" title="Logout">
